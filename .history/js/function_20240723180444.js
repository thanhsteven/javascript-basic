...
if (2 > 1) {
  let message = "Hello Kim Thành"; // * Let thì bên trong block scope sẽ không bị hoisting và không được đưa lên trên cùng trước khi load
  const mesage2 = "Hello again"; // * Const cũng vậy không được đưa lên trên như let
}
